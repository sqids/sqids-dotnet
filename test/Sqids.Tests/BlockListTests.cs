...
public class BlockListTests
{
	...
	public void EncodeAndDecode_WithDefaultBlockList_BlocksWordsInDefaultBlockList()
	{
		...
		sqids.Decode("sexy".AsSpan()).ShouldBeEquivalentTo(new[] { 200044 });
	...
	public void EncodeAndDecode_WithCustomBlockList_OnlyBlocksWordsInCustomBlockList()
	{
		...
		sqids.Decode("AvTg".AsSpan()).ShouldBeEquivalentTo(new[] { 100000 });
		sqids.Encode(100000).ShouldBe("7T1X8k");
		sqids.Decode("7T1X8k".AsSpan()).ShouldBeEquivalentTo(new[] { 100000 });
	}
	...
	public void EncodeAndDecode_WithBlockListBlockingMultipleEncodings_RespectsBlockList()
	{
		...
		sqids.Decode("TM0x1Mxz".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
	}
	...
	public void Decode_BlockedIds_StillDecodesSuccessfully()
	{
		...
		sqids.Decode("8QRLaD".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
		sqids.Decode("7T1cd0dL".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
		sqids.Decode("RA8UeIe7".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
		sqids.Decode("WM3Limhw".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
		sqids.Decode("LfUQh4HN".AsSpan()).ShouldBeEquivalentTo(new[] { 1, 2, 3 });
	}
	...
	public void EncodeAndDecode_WithShortCustomBlockList_RoundTripsSuccessfully()
	{
		...
		sqids.Decode(sqids.Encode(1000).AsSpan()).ShouldBeEquivalentTo(new[] { 1000 });
	}
}
